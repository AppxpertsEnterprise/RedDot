      ...
      <div className="container max-w-screen-xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between space-x-20">
          ...
          {/* Charity for the <br /> world better life */}
            ...
            RedDot Technologiess is a Software Development company <br />which offers next-generation IT Services that could empower your <br /> businesses to become self-reliant and sufficient. 
            </p>
