...
const { singleNavItemsTwo, logo_light, bg } = headerData;

const HeaderTwoSingleCloned = () => {
    ...
    return (
        <header className={`main-header-two sticky-header sticky-header--one-page sticky-header--cloned   ${scrollTop ? "active " : ""}`}>
            <Container >
