...
const HeaderSevenCloned = () => {
    const scrollToTop = useScrollUp(130);
    const { toggleSearch, handleToggle, } = useRootContext();
    return (
        <header className={`main-header-seven sticky-header sticky-header--normal sticky-header--cloned  ${scrollToTop ? "active" : ""}`}>
            <Container >
...
export default HeaderSevenCloned;