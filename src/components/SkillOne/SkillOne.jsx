                ...
                <Row>
                  ...
                  <Col md={7}>
                    {contents.map(({ id, progress, text, title }) => (
                      ...
                      //                 <input type="text" className="dial" data-fgColor="#DF2A16" data-bgColor="#c8c8c8" data-width="60" data-height="60" data-linecap="normal" value="45">
                    ...
                    {/* <div className="skill-one__content__skill">
                          ...
                          <div className="skill-one__content__skill">
                              <div className="progress-box">
                                  <div className="graph-outer">
                                      <input type="text" className="dial" data-fgColor="#DF2A16" data-bgColor="#c8c8c8" data-width="60" data-height="60" data-linecap="normal" value="85">
                                      <div className="inner-text count-box">
