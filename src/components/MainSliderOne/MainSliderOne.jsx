                      ...
                      <div className="main-slider-one__content">
                        ...
                        <div className="main-slider-one__bottom">
                          <div className="main-slider-one__btn">
                            <a href="contact" className="tolak-btn tolak-btn--base">
                              <b>Contact Now</b>
                              <span></span>
                            </a>
                          </div>
...
{/* 
      ...
      <div className="main-slider-one__project wow fadeInUp" data-aos="fade-up" data-aos-delay="200">
